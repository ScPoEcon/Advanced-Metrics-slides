...
starwars_dt[ , eye_cat := fcase(
  ...
  eye_color %chin% c("blue","gold","green, yellow","orange","pink",
                     "red","red, blue"), "funky",
  eye_color %chin% c("white","yellow"), "light"
)]
    ...
    mutate(eye_cat_m = case_when(
      sex %in% c("male","none") ~ ifelse(
        eye_color %in% c("black","blue-gray","brown","dark","hazel"),"dark",
          ifelse(eye_color %in% c("blue","gold","green, yellow","orange","pink",
                     "red","red, blue"), "funky",
                 ifelse(c("white","yellow"), "light", NA)
          )
        ), 

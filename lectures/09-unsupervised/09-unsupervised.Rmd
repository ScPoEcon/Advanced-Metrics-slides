...
## What to do when you have 81 potential predictors?
...
* So: at MSE-minimizing $\lambda$, we went down to 160 variables.
...
* We will talk about Principal Component Analysis (PCA)

* And about Clustering methods.
